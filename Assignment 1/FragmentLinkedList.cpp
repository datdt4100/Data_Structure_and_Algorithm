...
public:
    ...
    virtual int getnumF() { return this->numfrag; }
    virtual T getdataF(int index) { return this->fragmentPointers[index]->data; }
...
T FragmentLinkedList<T>::removeAt(int index)
{
	...
	if (index < 0 || index > (this->count - 1)){
		...
		if (this->fragmentPointers[0] != nullptr) delete this->fragmentPointers[0];
		if (this->fragmentPointers[1] != nullptr) delete this->fragmentPointers[1];
		this->fragmentPointers[0] = NULL;
        this->fragmentPointers[1] = NULL;
        this->count--;
	} else {
